...
if (argv.help) {
  ...
  console.log(
    "\t--vote-repository-path (alias -R): Path to a local clone of the " +
      "repository. If not provided, it will be cloned from SSH (or HTTPS if " +
      "an HTTPS remote is provided)."
  );
  console.log(
    "\t--github-repo-name: GitHub repository, in the format owner/repo."
  );
  console.log(
